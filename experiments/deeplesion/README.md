...
***Figure 1: a visualization of model performance on the validation data. This is how well the model could reasonably be expected to perform in practice. The ground truth (physician's judgment) is in <span style="color:yellow">yellow</span>, and the model's prediction is in <span style="color:green">green</span>.***
