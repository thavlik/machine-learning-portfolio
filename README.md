...
- [Grasp-and-Lift EEG Detection](experiments/grasp_and_lift_eeg/README.md): fine-grain detection of motor activity using EEG (WIP)
- [Neural Rendering](experiments/graphics/README.md): single-shot, differentiable 3D rendering (WIP)
